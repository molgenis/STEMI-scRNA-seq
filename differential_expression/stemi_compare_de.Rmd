...
gse_limma_lfc05 <- get_pathways_per_celltype_condition(pathway_output_loc = gse.output.limma.lfc05.loc, pval_cutoff = 0.05, append = '_positive.tsv')
gse_limma_lfc01 <- get_pathways_per_celltype_condition(pathway_output_loc = gse.output.limma.lfc01.loc, pval_cutoff = 0.05, append = '_positive.tsv')
gse_limma_nolfc <- get_pathways_per_celltype_condition(pathway_output_loc = gse.output.limma.nolfc.loc, pval_cutoff = 0.05, append = '_positive.tsv')
# get lists
...
pathways_celltype_comparisons_lfc01_vs_05 <- create_lists_from_pathway_tables(gse_limma_lfc01, gse_limma_lfc05, name_table_1 = 'LFC 0.1', name_table_2 = 'LFC 0.5', significance_cutoff_table_1 = 0.05, significance_cutoff_table_2 = 0.05)
...
plot_grid(
  ggVennDiagram(pathways_celltype_comparisons_lfc01_vs_05[['monocyte']][['UT-Baseline']]) + ggtitle('C vs t0'),
  ggVennDiagram(pathways_celltype_comparisons_lfc01_vs_05[['monocyte']][['t24h-Baseline']]) + ggtitle('t0 vs t24h'),
  ggVennDiagram(pathways_celltype_comparisons_lfc01_vs_05[['monocyte']][['t8w-Baseline']]) + ggtitle('t0 vs t8w'),
  ggVennDiagram(pathways_celltype_comparisons_lfc01_vs_05[['monocyte']][['t8w-t24h']]) + ggtitle('t24h vs t8w'),
  nrow = 2,
  ncol = 2
)
