...
plot_effect_sizes <- function(de_table, set_1_column, set_2_column, category_column=NULL, pointless=F, legendless=F, ylim=NULL, xlim=NULL, paper_style=T, category_order=NULL) {
  # create the plot
  p <- NULL
...
plot_grid(
  ...
  plot_effect_sizes(unsigned_mast_vs_limma_both_effect_sizes[unsigned_mast_vs_limma_both_effect_sizes$combination == 't8w-t24h' & unsigned_mast_vs_limma_both_effect_sizes$cell_type == 'CD8T', ], set_1_column = 'mast_meta_unsigned', set_2_column = 'limma_both', category_column = 'significant', legendless = F, xlim = NULL, ylim=NULL, category_order = c('neither')) + ggtitle('CD8T t0 vs t8w significance') + scale_color_manual(values = list('both' = 'darkgreen', 'limma_both' = 'gold2', 'mast_meta_unsigned' = 'blue', 'neither' = 'gray')),
