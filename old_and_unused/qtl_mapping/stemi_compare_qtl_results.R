############################################################################################################################
# Authors: Roy Oelen
# Name: stemi_compare_qtl_results.R
# Function: check the difference between two QTL mapping results
############################################################################################################################
...
egenes_shared_and_unique_to_numbers_plot <- function(eqtl_output_loc_1, eqtl_output_loc_2, name_1, name_2, condition_split=T, use_label_dict=T, cell_types=c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'), stims=c('Baseline', 't24h', 't8w'), ggarrange_method=F, paper_style=F){
  # get a numbers table
