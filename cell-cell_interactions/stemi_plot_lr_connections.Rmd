...
plot_grid(
  interactions_to_bars(lr_nrs_Baseline_vs_t24h, legendless = T) + ylim(c(0, 400)),
...
plot_grid(
  ...
  plot_grid(
    ...
    plot_grid(
      ...
      # actual panel a
      interactions_to_bars(lr_nrs_Baseline_vs_t24h, legendless = T) + ylim(c(0, 400)) + ggtitle(''),
      # settings
      rel_heights = c(0.1, 1),
      nrow = 2
    ),
