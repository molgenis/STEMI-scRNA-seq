...
v2_t24h_vs_t8w_perct_omni_unweighted_loc <- '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/cell_cell_interactions/nichenet/objects/v2_t24h_vs_t8w_nichenet_onlymajors_perct_omni_unweighted.rds'
v2_t24h_vs_t8w_perct_omni_unweighted <- readRDS(v2_t24h_vs_t8w_perct_omni_unweighted_loc)
v3_t24h_vs_t8w_perct_omni_unweighted_loc <- '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/cell_cell_interactions/nichenet/objects/v3_t24h_vs_t8w_nichenet_onlymajors_perct_omni_unweighted.rds'
...
lr_v3_t24h_vs_t8w_perct_omni_unweighted[['interaction']] <- NULL
# merge all of them
lr_all <- merge(lr_v2_t24h_vs_t8w_perct_omni_unweighted, lr_v3_t24h_vs_t8w_perct_omni_unweighted, by = c('receiver', 'sender', 'ligand', 'receptor'), all = T)
...
lt_v3_t24h_vs_t8w_perct_omni_unweighted[['interaction']] <- NULL
# merge all of them
lt_all <- merge(lt_v2_t24h_vs_t8w_perct_omni_unweighted, lt_v3_t24h_vs_t8w_perct_omni_unweighted, by = c('receiver', 'sender', 'ligand', 'target'), all = T)
...
lr_filtered_Baseline_t24h_v3 <- filter_lr_by_lt_ligands(data.frame(lt_v3_t24h_vs_t8w_perct_omni_unweighted), lr_connections = data.frame(lr_v3_t24h_vs_t8w_perct_omni_unweighted), target_interaction_column = 'v3_t24h_vs_t8w', receptor_interaction_column = 'v3_t24h_vs_t8w')
...
lr_filtered_Baseline_t24h_v2 <- filter_lr_by_lt_ligands(data.frame(lt_v2_t24h_vs_t8w_perct_omni_unweighted), lr_connections = data.frame(lr_v2_t24h_vs_t8w_perct_omni_unweighted), target_interaction_column = 'v2_t24h_vs_t8w', receptor_interaction_column = 'v2_t24h_vs_t8w')
...
```{r, include=FALSE}
knitr::opts_chunk$set(echo = FALSE)
r_vs_t_v3_t24h_vs_t8w_perct_omni_unweighted <- check_ligand_receptor_and_target_numbers(lt_connections = data.frame(lt_v3_t24h_vs_t8w_perct_omni_unweighted), lr_connections = data.frame(lr_v3_t24h_vs_t8w_perct_omni_unweighted), target_interaction_column = 'v3_t24h_vs_t8w', receptor_interaction_column = 'v3_t24h_vs_t8w')
...
interactions_to_sankey_from_tables(
  list('Baseline-t24h' = list('timepoint1' = 'Baseline',
                              'timepoint2' = 't24h',
                              'table' = lr_nrs_t24h_vs_t8w),
       't24h-t8w' = list('timepoint1' = 't24h',
                         'timepoint2' = 't8w',
                         'table' = lr_nrs_t24h_vs_t8w)
       )
)
...
plot_grid(
  interactions_to_bars(lr_nrs_t24h_vs_t8w, legendless = T) + ylim(c(0, 400)),
  interactions_to_bars(lr_nrs_t24h_vs_t8w, legendless = T) + ylim(c(0, 400)) + ylab(''),
  get_legend(interactions_to_bars(lr_nrs_t24h_vs_t8w)),
  nrow = 1,
  ncol = 3,
...
plot_grid(
  ...
  plot_grid(
    ...
    plot_grid(
      ...
      plot_grid(
        ...
        ggdraw() + draw_label('L-R connections per receiver t0-t24h (V3 chemistry)', fontface = 'bold', x = 0, hjust = 0),
        nrow = 1,
        rel_widths = c(0.1, 1)
      ),
      # actual panel a
      interactions_to_bars(lr_nrs_t24h_vs_t8w, legendless = T) + ylim(c(0, 400)) + ggtitle(''),
      # settings
      rel_heights = c(0.1, 1),
      nrow = 2
    ),
    ...
    plot_grid(
      ...
      plot_grid(
        ...
        ggdraw() + draw_label('L-R connections per receiver t24h-t8w (V3 chemistry)', fontface = 'bold', x = 0, hjust = 0),
        nrow = 1,
        rel_widths = c(0.1, 1)
      ),
      # actual panel b
      interactions_to_bars(lr_nrs_t24h_vs_t8w, legendless = T) + ylim(c(0, 400)) + ylab('') + ggtitle(''),
      # settings
      rel_heights = c(0.1, 1),
      nrow = 2
    ),
  ...
  plot_grid(
    ...
    plot_grid(
      ...
      # actual panel c
      as.grob(lr_pairs_to_upset(lr_overlap_received_v3_Baseline_vs_t8w)),
      # settings
      rel_heights = c(0.1, 1),
      nrow = 2
    ),
    ...
    plot_grid(
      ...
      plot_grid(
        ...
        ggdraw() + draw_label('LR-sharedness per receiving cell type t24h-t8w (V3 chemistry)', fontface = 'bold', x = 0, hjust = 0),
        nrow = 1,
        rel_widths = c(0.1, 1)
      ),
      # actual panel d
      as.grob(lr_pairs_to_upset(lr_overlap_received_v3_t24h_vs_t8w)),
      # settings
      rel_heights = c(0.1, 1),
      nrow = 2
    )
