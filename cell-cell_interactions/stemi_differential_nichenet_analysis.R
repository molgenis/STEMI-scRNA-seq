...
# prio_t0_t8w <- do_differential_nichenet(cardio_integrated, 'cell_type_lowerres', 'timepoint.final', 't8w', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'), include_chem='chem', donor_latent=T)
# prio_t0_t24h <- do_differential_nichenet(cardio_integrated, 'cell_type_lowerres', 'timepoint.final', 't24h', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'), include_chem='chem', donor_latent=T)
# prio_t24h_8w <- do_differential_nichenet(cardio_integrated, 'cell_type_lowerres', 'timepoint.final', 't8w', 't24h', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK', include_chem='chem', donor_latent=T))
# prio_c_t0 <- do_differential_nichenet(cardio_integrated, 'cell_type_lowerres', 'timepoint.final', 'Baseline', 'UT', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'), include_chem='chem', donor_latent=T)
...
prio_t0_t24h_v3 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V3'], 'cell_type_lowerres', 'timepoint.final', 't24h', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
saveRDS(prio_t0_t24h_v3, '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/stemi_nichenet_de_prio_t0_t24h_v3.rds')
prio_t24h_8w_v3 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V3'], 'cell_type_lowerres', 'timepoint.final', 't8w', 't24h', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
saveRDS(prio_c_t0_v3, '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/stemi_nichenet_de_prio_c_t0_v3.rds')
prio_t0_t8w_v3 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V3'], 'cell_type_lowerres', 'timepoint.final', 't8w', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
saveRDS(prio_t0_t8w_v3, '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/stemi_nichenet_de_prio_t0_t8w_v3.rds')
prio_c_t0_v3 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V3'], 'cell_type_lowerres', 'timepoint.final', 'Baseline', 'UT', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
...
prio_t0_t24h_v2 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V2'], 'cell_type_lowerres', 'timepoint.final', 't24h', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
saveRDS(prio_t0_t24h_v2, '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/stemi_nichenet_de_prio_t0_t24h_v2.rds')
prio_t24h_8w_v2 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V2'], 'cell_type_lowerres', 'timepoint.final', 't8w', 't24h', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
...
prio_t0_t8w_v2 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V2'], 'cell_type_lowerres', 'timepoint.final', 't8w', 'Baseline', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
saveRDS(prio_t0_t8w_v2, '/groups/umcg-franke-scrna/tmp01/releases/blokland-2020/v1/stemi_nichenet_de_prio_t0_t8w_v2.rds')
prio_c_t0_v2 <- do_differential_nichenet(cardio_integrated[, cardio_integrated@meta.data[['chem']] == 'V2'], 'cell_type_lowerres', 'timepoint.final', 'Baseline', 'UT', test_use='DESeq2', pseudobulk=T, cell_types_of_interest = c('B', 'CD4T', 'CD8T', 'DC', 'monocyte', 'NK'))
